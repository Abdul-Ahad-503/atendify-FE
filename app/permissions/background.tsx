        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              • Automatic check-in when arriving
            </Text>
            <Text style={styles.infoText}>
              • Continuous attendance monitoring
            </Text>
            <Text style={styles.infoText}>• Auto check-out when leaving</Text>
          </View>
          ...
          <View style={styles.noteBox}>
            ...
            <Text style={styles.noteText}>
              We use efficient location tracking to minimize battery usage
            </Text>
          </View>
